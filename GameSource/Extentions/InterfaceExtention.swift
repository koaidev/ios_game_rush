...
class InterfaceExtention {
     ...
     */
    static func put(nodesWithArray nodes: [SimpleSprite], atPosition positionToSet: CGPoint, withSpaceBetween space: CGFloat, andSortHorizontal horizontalSorting: Bool) {
        ///Get all object size
    ...
    static func put(nodesWithArray nodes: [ButtonNode], atPosition positionToSet: CGPoint, withSpaceBetween space: CGFloat, andSortHorizontal horizontalSorting: Bool) {
        put(nodesWithArray: nodes as [SimpleSprite], atPosition: positionToSet, withSpaceBetween: space, andSortHorizontal: horizontalSorting)
