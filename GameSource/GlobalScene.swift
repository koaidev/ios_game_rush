...
class GlobalScene: SKScene {
    ...
    //Values
    var scaleBackgroundAtTapToScreen = true
    ...
    func loadScene(_ nameScene: SceneName, withTransitionName nameTransition: TransitionName) {
        ...
        UserDefaults.standard.set(UserDefaults.standard.integer(forKey: "_currentSceneLoaded"), forKey: "_previousSceneLoaded")
    ...
    public static func getPreviousLoadedScene() -> GlobalScene.SceneName {
        return GlobalScene.SceneName(rawValue: UserDefaults.standard.integer(forKey: "_previousSceneLoaded"))!
    }
    ...
    //MARK: - Animations
    private func runAnimationBackgroundTouch() {
        if SettingsGameProcess.Interface.Background.AnimationsAtTap.Scale.on {
            background.run(SKAction.sequence([
                                SKAction.scale(to: SettingsGameProcess.Interface.Background.AnimationsAtTap.Scale.scaleTo, duration: SettingsGameProcess.Interface.Background.AnimationsAtTap.Scale.lifetime / 2),
                                SKAction.scale(to: 1.0, duration: SettingsGameProcess.Interface.Background.AnimationsAtTap.Scale.lifetime / 2)]))
        }
    }
